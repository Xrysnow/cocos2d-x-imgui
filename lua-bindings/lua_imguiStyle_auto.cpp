...
int lua_x_imguiPatch1_ImGuiStyle_getWindowMenuButtonPosition(lua_State* tolua_S)
{
	ImGuiStyle* cobj = nullptr;
#if COCOS2D_DEBUG >= 1
	tolua_Error tolua_err;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_x_imguiPatch1_ImGuiStyle_getWindowMenuButtonPosition'", nullptr);
		return 0;
	}
#endif
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_x_imguiPatch1_ImGuiStyle_getWindowMenuButtonPosition'.", &tolua_err);
				return 0;
#endif
}
int lua_x_imguiPatch1_ImGuiStyle_setWindowMenuButtonPosition(lua_State* tolua_S)
{
	int argc = 0;
	ImGuiStyle* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_x_imguiPatch1_ImGuiStyle_setWindowMenuButtonPosition'", nullptr);
		return 0;
	}
#endif
	argc = lua_gettop(tolua_S) - 1;
